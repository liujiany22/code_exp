...
TRIGGER_NEURACLE_DEVICE_ID = _int_from_env_or_local("TRIGGER_NEURACLE_DEVICE_ID", 1)
TRIGGER_NEURACLE_OUTPUT_FUNCTION_ID = _int_from_env_or_local(
    "TRIGGER_NEURACLE_OUTPUT_FUNCTION_ID",
    225,
)
TRIGGER_NEURACLE_ERROR_FUNCTION_ID = _int_from_env_or_local(
    "TRIGGER_NEURACLE_ERROR_FUNCTION_ID",
    131,
)
TRIGGER_NEURACLE_DEVICE_NAME_FUNCTION_ID = _int_from_env_or_local(
...
PSYCHOPY_AUDIO_LIB = _str_from_env_or_local("PSYCHOPY_AUDIO_LIB", "ptb")
...
LEARNING_CYCLE_SEGMENT_SECONDS = 180.0
LEARNING_CYCLE_SEGMENT_RATING_MIN = 1
LEARNING_CYCLE_SEGMENT_RATING_MAX = 5
