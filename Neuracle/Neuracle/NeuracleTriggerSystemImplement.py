from Trigger.TriggerSystemInterface import TriggerSystemInterface
from Trigger.Neuracle.triggerBox import *
import sys
import time
import os
import threading
...
class NeuracleTriggerSystemImplement(TriggerSystemInterface):
    ...
    def __init__(self, triggerBoxHandle:str, port):
        ...
        # self.timer = threading.Timer(0.02, self.__reset, (self.event,))
